...
public class Array_Exempo_1 {
	...
	public static void main(String[] args) {
		...
		System.out.println("Exemplo 4 - Maior número no vetor: ");
		...
		for (int i = 1; i < dados.length; i++) {
			...
			if (dados[i] > maior) {
				...
				maior = dados[i];
				System.out.println("O maior numero agora é o: " + maior);
			}
		}
		...
		System.out.println("Exemplo  5 - Quantos números são maiores de 10: "+ contador);
	}
